...
public class AbNumericWheelAdapter implements AbWheelAdapter {
	...
	//步长
	private static final int default_buchang = 1;
	private int buchang;
	/**
	 * Default constructor.
	 */
	public AbNumericWheelAdapter() {
		this(DEFAULT_MIN_VALUE, DEFAULT_MAX_VALUE,default_buchang);
	}
	 ...
	 */
	public AbNumericWheelAdapter(int minValue, int maxValue, int buchang) {
		this(minValue, maxValue,buchang, null);
	}
	 ...
	 */
	public AbNumericWheelAdapter(int minValue, int maxValue,int buchang, String format) {
	...
	public String getItem(int index) {
		if (index >= 0 && index < getItemsCount()) {
			int value = minValue + index*buchang;
	...
	public int getItemsCount() {
		return (maxValue - minValue)/buchang + 1;
	}
