...
public class AbWheelView extends View {
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (maxLength > 0) {
			//一个字符宽度
			float textWidth = (int)AbGraphicUtil.getStringWidth("哈", labelPaint);
			//不算lable的宽度
	...
	public void setValueTextSize(int textSize) {
		this.valueTextSize = AbGraphicUtil.scale(mContext, textSize);
	...
	public void setLabelTextSize(int labelTextSize) {
		this.labelTextSize = AbGraphicUtil.scale(mContext, labelTextSize);
	}
