...
public class SimpleNaviActivity extends BaseActivity implements
   ...
   //是否为模拟导航
	...
	private void processBundle(Bundle bundle) {
		if (bundle != null) {
			mIsEmulatorNavi = bundle.getBoolean(DaoHangUtils.ISEMULATOR, true);
			mCode=bundle.getInt(DaoHangUtils.ACTIVITYINDEX);
		}
	}
...
//-----------------------------导航界面回调事件------------------------
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			if(mCode==DaoHangUtils.SIMPLEROUTENAVI){
				Intent intent = new Intent(SimpleNaviActivity.this,
			...
			else if(mCode==DaoHangUtils.SIMPLEGPSNAVI){
				Intent intent = new Intent(SimpleNaviActivity.this,
						LocationActivity.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
				intent.putExtra("isBack", true);
