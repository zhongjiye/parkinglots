...
import com.sunrise.epark.activity.NotecaseChongzhiActivity;
...
public class PayMain{
	...
	public PayMain(Activity context,Handler handler){
		this.context = context;
		this.mHandler = handler;
	}
	

	public void pay(String title,String miaoshu, String orderId,String money){

		// TODO Auto-generated method stub
		// 订单
		String orderInfo = getOrderInfo(title, miaoshu,orderId, money);
	...
	public String getOrderInfo(String subject, String body,String orderId, String price) {
		...
		// 服务器异步通知页面路径
		orderInfo += "&notify_url=" + "\"" + Urls.AL_RESPONSE+ "\"";
